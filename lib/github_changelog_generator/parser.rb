  ...
  class Parser
    ...
    def self.setup_parser(options)
      OptionParser.new do |opts| # rubocop:disable Metrics/BlockLength
        ...
        opts.on("--configure-sections [HASH]", "Define your own set of sections which overrides all default sections") do |v|
          options[:configure_sections] = v
        end
        opts.on("--add-sections [HASH]", "Add new sections but keep the default sections") do |v|
